	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				The default payment time for crypto is 60 minutes (including Ethereum, USDC, USDT). If you are using KidaPay invoice web url, you will see the countdown timer. If you are building your in-house app, the expired at field can be found at invoice.expired_at_t. For those orders without selecting crypto payments, it will be expired after 3 hours.
			</td>
		</tr>
		<tr>
			<td>CANCELED</td>
